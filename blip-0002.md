...
The following table contains extension tlv fields for BOLT 12 `offer`s:

| Type       | Name                                   | Link                       |
|------------|----------------------------------------|----------------------------|
| 1000000057 | `offer_signature`                      | [bLIP 56](./blip-0056.md)  |
| 1000000059 | `offer_invoice_request_https_endpoint` | [bLIP 57](./blip-0057.md)  |
| 1000000061 | `offer_invoice_request_nostr_endpoint` | [bLIP 59](./blip-0059.md)  |

These values are arbitrary unused odd types in the BOLT 12 offer-extension
range and are not intended to encode bLIP numbers. They should not be
changed solely because a bLIP number is reassigned.
